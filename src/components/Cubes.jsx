...
const Cubes = ({
  ...
  return (
    <div className="relative w-full h-full aspect-square" style={wrapperStyle}>
        ...
        {cells.map((_, r) =>
          cells.map((__, c) => (
            ...
            >
              ...
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'translateY(-50%) rotateX(90deg)' }} />
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'translateY(50%) rotateX(-90deg)' }} />
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'translateX(-50%) rotateY(-90deg)' }} />
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'translateX(50%) rotateY(90deg)' }} />
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'rotateY(-90deg) translateX(50%) rotateY(90deg)' }} />
              <div className="cube-face absolute inset-0" style={{ ...faceBase, transform: 'rotateY(90deg) translateX(-50%) rotateY(-90deg)' }} />
            </div>
          ))
        )}
